...
def test_digital_demo():
    expected_discrete = [
        ['离散观察欧式Call二元期权', 0.7813384345830714, 0.7800421042175157, 0.7722835839041402, 0.812813152699443,
         0.7891833475907255],
        ['离散观察欧式Put二元期权', 1.2726911914338912, 1.2630840104230847, 1.2731902121549123, 1.2895615455303617,
         1.2913388609349215],
        ['离散观察美式Call二元期权', 1.6766870002507048, 1.6744733936099303, 1.657521761793372, 1.6688088109426866,
         1.670733761754569],
        ['离散观察美式Put二元期权', 2.1376442967454254, 2.134676670727452, 2.1407896427877984, 2.0890054574578123,
         2.1428078891800553],
        ['离散观察美式Call二元期权', 1.6909576756985945, 1.688528407429802, 1.6715212118040825, 1.6828563953693552,
         1.6849260212121293],
        ['离散观察美式Put二元期权', 2.1530488132491263, 2.1497975527515845, 2.1561525555229144, 2.1037244495819074,
         2.1582634329368275]]
    expected_continuous = [['连续观察欧式Call二元期权', 0.7813384345830714, 0.789183],
                           ['连续观察欧式Put二元期权', 1.2726911914338912, 1.291339],
                           ['连续观察美式Call二元期权', 1.8021622711412713, 1.799008],
                           ['连续观察美式Put二元期权', 2.269883592086009, 2.263541],
                           ['连续观察美式Call二元期权', 1.817889647827623, 1.814803],
                           ['连续观察美式Put二元期权', 2.286636690933101, 2.280384]]

...
def lite():
    """简易定价接口"""
    option = BothDownSnowball(maturity=2, lock_term=3, s0=100, barrier_out_start=103, barrier_out_step=0.5,
                              barrier_in=80, coupon_ko_start=0.194, coupon_ko_step=0.005,
...
def run():
    ...
    # 4. 定义产品：双降雪球
    option = BothDownSnowball(maturity=2, s0=100, start_date=datetime.date(2022, 1, 5),
                              trade_calendar=CN_CALENDAR, barrier_out_start=103, barrier_out_step=0.5, barrier_in=80,
                              coupon_ko_start=0.194, coupon_ko_step=0.005, coupon_div=None, lock_term=3, pay_dates=None,
                              engine=None, status=StatusType.NoTouch)
    # 5.为产品设置定价引擎

...
def lite():
    """简易定价接口"""
    option = FlooredSnowball(maturity=2, lock_term=3, s0=100, barrier_out=100, barrier_in=75, coupon_out=0.089,
                             strike_lower=75, margin_lvl=1, s=100, r=0.02, q=0.03, vol=0.15)
...
def run():
    ...
    option = FlooredSnowball(maturity=2, s0=100, start_date=datetime.date(2022, 1, 4),
                             trade_calendar=CN_CALENDAR, barrier_out=100, barrier_in=75, coupon_out=0.089,
                             coupon_div=None, lock_term=3, margin_lvl=1, strike_lower=75, engine=None,

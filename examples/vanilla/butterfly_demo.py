...
def lite():
    """简易定价接口"""
    option = Butterfly(callput=CallPut.Call, lower_strike=90, middle_strike=100, upper_strike=110, maturity=1,
...
def run():
    ...
    for callput in CallPut:
        port = Butterfly(lower_strike=90, middle_strike=100, upper_strike=110, maturity=1, callput=callput,
                         t_step_per_year=243)

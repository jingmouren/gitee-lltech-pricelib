...
def lite():
    """简易定价接口"""
    option = RiskReversal(lower_strike=90, higher_strike=110, maturity=0.5, callput=CallPut.Call,
...
def run():
    ...
    for callput in CallPut:
        port = RiskReversal(lower_strike=90, higher_strike=110, maturity=0.5, callput=callput)

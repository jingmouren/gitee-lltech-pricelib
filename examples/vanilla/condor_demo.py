...
def lite():
    """简易定价接口"""
    option = Condor(strike1=80, strike2=90, strike3=110, strike4=120, maturity=0.5, callput=CallPut.Call,
...
def run():
    ...
    for callput in CallPut:
        port = Condor(strike1=80, strike2=90, strike3=110, strike4=120, maturity=0.5, callput=callput)

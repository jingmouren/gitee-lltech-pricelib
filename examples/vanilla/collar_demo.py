...
def lite():
    """简易定价接口"""
    option = Collar(callput=CallPut.Call, lower_strike=90, higher_strike=110, maturity=0.5,
...
def run():
    ...
    for callput in CallPut:
        port = Collar(lower_strike=90, higher_strike=110, maturity=0.5, callput=callput)

...
def lite():
    """简易定价接口"""
    option = DiscountCall(strike=100, participate=0.8, maturity=0.5, callput=CallPut.Call,
...
def run():
    ...
    # 4. 定义产品：折价看涨期权
    results = []
    port = DiscountCall(strike=100, participate=0.8, maturity=0.5, callput=CallPut.Call)
